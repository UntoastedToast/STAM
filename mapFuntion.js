...
function addGrafittiToDatabase() {
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            xhr2.open("POST", "GraffitiServer.php", false);
    ...
    console.log("hallo4");
    xhr.open("POST", "BildAbspeichern.php", false);
    console.log("hallo5");
    xhr.send(formData);
...
function deleteTheNulls(){
    ...
    xhr3.open('POST', 'removeTheNulls.php');
